...
/****************************************************************
 * Implementation of the abstract FileSystem for the DFS system. This object is the way end-user
 * code interacts with a Hadoop DistributedFileSystem.
 *
 * @author Mike Cafarella
 *****************************************************************/
public class DistributedFileSystem extends FileSystem {
    private File   workingDir = new File("/user",
                                         System.getProperty("user.name")).getAbsoluteFile();
    ...
    public DistributedFileSystem(InetSocketAddress namenode,
        ...
        super(conf);
        this.dfs = new DFSClient(namenode,
                                 conf);
        this.name = namenode.getHostName() +
                    ":" +
                    namenode.getPort();
    }
    ...
    private void doFromLocalFile(File src,
                                 File dst,
        ...
        FileSystem localFs = getNamed("local",
                                      getConf());
    ...
    public void completeLocalOutput(File fsOutputFile,
                                    File tmpLocalFile) throws IOException {
        moveFromLocalFile(tmpLocalFile,
                          fsOutputFile);
    }
