...
/**
 * A simple RPC mechanism. A <i>protocol</i> is a Java interface. All parameters and return types
 * must be one of:
 * <ul>
 * <li>a primitive type, <code>boolean</code>, <code>byte</code>, <code>char</code>,
 * <code>short</code>, <code>int</code>, <code>long</code>, <code>float</code>, <code>double</code>,
 * or <code>void</code>; or</li>
...
public class RPC {
    ...
    private static class Invocation implements Writable, Configurable {
        ...
        public void readFields(DataInput in) throws IOException {
            ...
            for (int i = 0; i < parameters.length; i++) {
                parameters[i] = ObjectWritable.readObject(in,
                                                          objectWritable,
                                                          this.conf);
        ...
        public Invoker(InetSocketAddress address,
            ...
            if (CLIENT == null) {
                CLIENT = new Client(ObjectWritable.class,
                                    conf);
                conf.setObject(Client.class.getName(),
                               CLIENT);
            }
        }
    ...
    /**
     * Construct a client-side proxy object that implements the named protocol, talking to a server
    ...
    public static Object[] call(Method method,
        ...
        for (int i = 0; i < params.length; i++)
            invocations[i] = new Invocation(method,
                                            params[i]);
        CLIENT = (Client) conf.getObject(Client.class.getName());
        if (CLIENT == null) {
            CLIENT = new Client(ObjectWritable.class,
        ...
        Writable[] wrappedValues = CLIENT.call(invocations,
                                               addrs);
    ...
    public static class Server extends org.apache.hadoop.ipc.Server {
        ...
        public Writable call(Writable param) throws IOException {
            try {
                ...
                return new ObjectWritable(method.getReturnType(),
                                          value);
