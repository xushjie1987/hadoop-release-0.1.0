...
/**
 * Filesystem disk space usage statistics. Uses the unix 'df' program. Tested on Linux, FreeBSD,
 * Cygwin.
 */
public class DF {
    ...
    private void doDF() throws IOException {
        if (lastDF +
            dfInterval > System.currentTimeMillis())
            return;
        Process process;
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(new DF(path,
