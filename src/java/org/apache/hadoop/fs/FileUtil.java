...
public class FileUtil {
    ...
    public static boolean fullyDelete(File dir,
        ...
        return fullyDelete(new LocalFileSystem(conf),
                           dir);
    }
    ...
    public static boolean copyContents(FileSystem fs,
        ...
        if (fs.isFile(src)) {
            ...
            try {
                FSOutputStream out = fs.createRaw(dst,
                                                  true);
                byte buf[] = new byte[conf.getInt("io.file.buffer.size",
                                                  4096)];
                try {
